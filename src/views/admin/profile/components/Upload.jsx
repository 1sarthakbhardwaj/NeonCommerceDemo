...
const Upload = () => {
  return (
    <Card className="grid h-full w-full grid-cols- gap-3 rounded-[20px] bg-white bg-clip-border p-3 font-dm shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:shadow-none 2xl:grid-cols-11">
